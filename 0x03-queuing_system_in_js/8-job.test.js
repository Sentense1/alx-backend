...
describe('createPushNotificationsJobs', () => {
  ...
  it('display a error message if jobs is not an array parsing Number', () => {
    expect(() => {
  ...
  it('display a error message if jobs is not an array parsing Object', () => {
    expect(() => {
  ...
  it('display a error message if jobs is not an array parsing String', () => {
    expect(() => {
